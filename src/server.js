...
app.listen(PORT, () => {
  ...
  logger.info('Available endpoints:', {
    ...
    payees: '/v2/payees/* (incl. GET /v2/payees/common)',
    tags: '/v2/tags/*',
    notes: '/v2/notes/:id',
    preferences: 'GET /v2/preferences',
    accountGroups: '/v2/account-groups/*',
    budgets: '/v2/budgets/* (incl. POST /v2/budgets/batch)',
    budgetFiles: 'GET /v2/budget/files, POST /v2/budget/load, POST /v2/budget/export (admin)',
    sync: 'POST /v2/sync, POST /v2/accounts/:accountId/bank-sync',
    server: 'GET /v2/server/version',
    lookup: 'GET /v2/lookup/:type/:name',
    rules: '/v2/rules/*',
