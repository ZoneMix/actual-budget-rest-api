...
const envSchema = z.object({
  ...
  // call settles — so they get a longer budget rather than wedging the queue.
  ACTUAL_LOAD_TIMEOUT_MS: z.string().transform(Number).pipe(z.number().int().positive()).default(300000),
